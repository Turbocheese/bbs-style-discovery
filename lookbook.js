...
var lookbookData = [
    ...
    {
        id: "look-khaki-jungle",
        img: "images/lookbook/bbs-editorial-jc4619.jpg",
        title: "The Jungle Jacket, Khaki",
        season: "Warm Weather",
        category: "Jackets",
        tags: ["Jungle Jacket", "Rounded Pockets", "White Trouser"],
        note:
            "A khaki jungle jacket — rounded patch pockets, no belt — over white trousers against warm brick. A lighter field silhouette, structure that still breathes.",
        guidePath: ["tailoring", "jackets", "other_styles", "jungle"],
        guideLabel: "Read: the Jungle Jacket",
    },
    {
        id: "look-black-field",
    ...
    },
    {
        ...
        title: "The Teba Jacket, Oat",
        season: "Resort",
        category: "Jackets",
        tags: ["Teba Jacket", "Fine Knit", "White Trouser"],
        note:
            "An oat teba jacket over a fine knit with white trousers, worn easy in warm light. Soft, unstructured shoulders and a shirt-like collar — the jacket you reach for when nothing needs saying.",
        guidePath: ["tailoring", "jackets", "other_styles", "teba"],
        guideLabel: "Read: the Teba Jacket",
    },
    {
        id: "look-grey-camp",
    ...
    },
    {
        ...
        title: "Checked Harrington, Fatigue Trouser",
        season: "Autumn",
        category: "Jackets",
        tags: ["Cropped Jacket", "Fatigue Trouser", "Loafers"],
        note:
            "A cropped checked jacket zipped over a turtleneck, olive fatigue trousers, black loafers — caught mid-stride on a timber staircase. The jacket stays cropped so the trouser's own volume can do the work.",
    ...
    },
    {
        ...
        title: "Fatigue Trouser, Dockside",
        season: "Coastal",
        category: "Trousers",
        tags: ["Fatigue Trouser", "Deep Pleats", "Safari Shirt"],
        note:
            "A four-pocket shirt tucked over deep-pleated fatigue trousers, hands in pockets on a wooden jetty. The cargo pocket sits low on the thigh, out of the way of a tucked-in shirt.",
        guidePath: ["tailoring", "trousers", "configuration", "pleats", "double_pleats"],
        guideLabel: "Read: Double Pleats",
    },
    {
    ...
    // August 2026.
    {
        id: "look-flight-blouson-library",
        img: "images/lookbook/bbs-editorial-jc8705.jpg",
        title: "Flight Blouson, Library Light",
        season: "Resort",
        category: "Jackets",
        tags: ["Beige Blouson", "Navy Polo", "Wood Panelling"],
        note:
            "A beige flight blouson worn open over a navy polo and cream trousers, in a wood-panelled room stacked with books. The polo collar does the only contrast work here.",
        guidePath: ["tailoring", "jackets", "other_styles", "flight"],
        guideLabel: "Read: the Flight Jacket",
    },
    {
        id: "look-trucker-tide-line",
        img: "images/lookbook/bbs-editorial-jc9927.jpg",
        title: "Trucker Jacket, Tide Line",
        season: "Coastal",
        category: "Jackets",
        tags: ["Pale Blue Jacket", "Striped Knit", "Olive Shorts"],
        note:
            "A pale blue trucker jacket over a striped knit and olive tailored shorts, walking a tide-washed shoreline. Patch pockets and a wide collar keep it easy rather than technical.",
        guidePath: ["tailoring", "jackets", "other_styles", "chore"],
        guideLabel: "Read: the Chore Jacket",
    },
    {
        id: "look-navy-trucker-rocky-coast",
        img: "images/lookbook/bbs-editorial-jc9974.jpg",
        title: "Navy Trucker, Rocky Coast",
        season: "Coastal",
        category: "Jackets",
        tags: ["Navy Jacket", "Olive Polo", "Director's Chair"],
        note:
            "A navy trucker jacket over an olive polo and beige trousers, seated on a weathered bamboo director's chair against red coastal rock. The polo's tipped collar is the only pattern in the frame.",
        guidePath: ["tailoring", "jackets", "other_styles", "chore"],
        guideLabel: "Read: the Chore Jacket",
    },
    {
        id: "look-side-adjuster-shore",
        img: "images/lookbook/bbs-editorial-jc9862.jpg",
        title: "Side-Adjuster, at the Shore",
        season: "Coastal",
        category: "Trousers",
        tags: ["Cream Knit Polo", "Side-Adjuster Waistband", "White Trousers"],
        note:
            "A cropped shot of a cream knitted polo and white trousers on a side-adjuster waistband, the gold buckle catching low beach light. No belt loops in sight — the trouser does its own fastening.",
        guidePath: ["tailoring", "trousers", "configuration", "waistbands", "side_adjusters"],
        guideLabel: "Read: Side Adjusters",
    },
    {
        id: "look-knit-polo-sea-cliff",
        img: "images/lookbook/bbs-editorial-jc9999.jpg",
        title: "Knit Polo, Sea Cliff",
        season: "Coastal",
        category: "Shirts",
        tags: ["Olive Knit Polo", "Beige Trousers", "Coastal Rock"],
        note:
            "An olive knitted polo with ivory tipping over beige trousers, on a clifftop above the sea. A bamboo director's chair is the only prop; the polo's tipped collar and cuffs do the rest.",
        guidePath: ["tailoring", "shirts", "use_case", "resort"],
        guideLabel: "Read: the Resort Shirt",
    },
    {
        id: "look-teba-amber-light",
        img: "images/lookbook/bbs-editorial-jc4536.jpg",
        title: "Teba Jacket, Amber Light",
        season: "Resort",
        category: "Jackets",
        tags: ["Navy Teba", "Ornate Belt Buckle", "Wood Panelling"],
        note:
            "A close crop of a navy teba jacket over a tan knit, caught in warm interior light against a teak wall. The buckle is the one loud note in an otherwise quiet frame.",
        guidePath: ["tailoring", "jackets", "other_styles", "teba"],
        guideLabel: "Read: the Teba Jacket",
    },
    {
        id: "look-workwear-reading-room",
        img: "images/lookbook/bbs-editorial-jc4702.jpg",
        title: "Workwear Jacket, Reading Room",
        season: "Resort",
        category: "Jackets",
        tags: ["Oatmeal Jacket", "Flat Cap", "Paper Lantern"],
        note:
            "An oatmeal workwear jacket and matching flat cap in a book-lined reading room, a paper lantern hanging low overhead. The patch pockets and notch collar keep it closer to a shirt-jacket than a blazer.",
        guidePath: ["tailoring", "jackets", "other_styles", "chore"],
        guideLabel: "Read: the Chore Jacket",
    },
    {
        id: "look-glen-check-volcanic-ridge",
        img: "images/lookbook/bbs-editorial-jc4841.jpg",
        title: "Glen Check, Volcanic Ridge",
        season: "Resort",
        category: "Jackets",
        tags: ["Glen Check Jacket", "Beanie", "Black and White"],
        note:
            "A glen check jacket over a cream knit and dark trousers, shot in black and white against a volcanic ridge. The check reads as pure texture at this distance.",
        guidePath: ["tailoring", "jackets", "other_styles", "flight"],
        guideLabel: "Read: the Flight Jacket",
    },
    {
        id: "look-beige-jacket-panelled-room",
        img: "images/lookbook/bbs-editorial-jc4648.jpg",
        title: "Beige Jacket, Panelled Room",
        season: "Resort",
        category: "Jackets",
        tags: ["Beige Jacket", "Cream Trousers", "Statement Rings"],
        note:
            "A beige jacket over a cream knit polo and wide cream trousers, against a wall of wood panelling. Sunglasses, a black beanie and stacked rings are the only departure from tone.",
        guidePath: ["tailoring", "jackets", "other_styles", "flight"],
        guideLabel: "Read: the Flight Jacket",
    },
    {
        id: "look-cargo-weathered-wall",
        img: "images/lookbook/bbs-editorial-jc4771.jpg",
        title: "Fatigue Trouser, Weathered Wall",
        season: "Resort",
        category: "Jackets",
        tags: ["Dark Jacket", "Fatigue Trouser", "Beret"],
        note:
            "A dark jacket worn open over a white shirt and khaki fatigue trousers, shot in black and white against a weathered stucco wall. A cream beret and sunglasses give it a continental cast.",
        guidePath: ["tailoring", "jackets", "other_styles", "flight"],
        guideLabel: "Read: the Flight Jacket",
    },
    {
        id: "look-jungle-sunset-stairwell",
        img: "images/lookbook/bbs-editorial-r0024735.jpg",
        title: "Jungle Jacket, Sunset Stairwell",
        season: "Resort",
        category: "Jackets",
        tags: ["Sage Jacket", "Draped Scarf", "Concrete Stairwell"],
        note:
            "A jungle jacket with a cream scarf draped loose over dark shorts, caught in low sun on a concrete stairwell. The scarf is doing all the softening against the jacket's utility pockets.",
        guidePath: ["tailoring", "jackets", "other_styles", "jungle"],
        guideLabel: "Read: the Jungle Jacket",
    },
    {
        id: "look-striped-resort-under-sail",
        img: "images/lookbook/bbs-editorial-r0028121.jpg",
        title: "Striped Resort Shirt, Under Sail",
        season: "Coastal",
        category: "Shirts",
        tags: ["Striped Resort Shirt", "Cream Trousers", "Sailboat Rigging"],
        note:
            "A striped resort shirt and cream trousers on the deck of a sailboat, rigging and rope overhead. Sunglasses and salt-loosened curls complete a look built entirely around the stripe.",
        guidePath: ["tailoring", "shirts", "use_case", "resort"],
        guideLabel: "Read: the Resort Shirt",
    },
    {
        id: "look-double-breasted-marina",
        img: "images/lookbook/bbs-editorial-r0028013.jpg",
        title: "Double-Breasted, at the Marina",
        season: "Coastal",
        category: "Suits",
        tags: ["Forest Green DB", "Black Tank", "Marina Dock"],
        note:
            "A forest-green double-breasted jacket worn open over a black ribbed tank, hand in pocket on a marina dock. Boats blur soft in the background; the jacket stays the only sharp thing in frame.",
        guidePath: ["tailoring", "suits", "styles", "double_breasted"],
        guideLabel: "Read: the Double-Breasted Suit",
    },
];
