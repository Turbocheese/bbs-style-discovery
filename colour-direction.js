...
var colourDirectionProfiles = {
    soft_tonal_warmth: {
        ...
        matching: [
            ...
            "Oat + Terracotta + Sand",
            "Mushroom + Soft Moss + Dark Chocolate",
        ],
        fabricFinish: {
    ...
    earth_led_balance: {
        ...
        matching: [
            ...
            "Sand + Moss + Tobacco",
            "Mushroom + Dark Chocolate + Deep Moss",
        ],
        fabricFinish: {
