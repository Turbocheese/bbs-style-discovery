...
// invalid topic_kind, total topics = 288.
...
console.log("Total topics scanned: " + topics.length + (topics.length === 288 ? "  (expected 288: PASS)" : "  (EXPECTED 288: FAIL)"));
...
var failed = missingMeta.length + missingCore.length + missingKind.length + invalidKind.length + (topics.length === 288 ? 0 : 1);
