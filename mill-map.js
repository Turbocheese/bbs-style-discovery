...
var MILL_MAP_PINS = [
    ...
    { key: "standeven", short: "Standeven", name: "Standeven", place: "Halifax, England", region: "Britain", cluster: "yorkshire", est: 1885, lat: 53.72, lon: -1.86, blurb: "Classic English suiting character: structure, resilience, and cloth that improves with wear.", guidePath: ["cloth_origins", "suiting", "english", "standeven"], fabricKey: "wool_linen" },
    ...
    { key: "drago", short: "Drago", name: "Drago", place: "Biella", region: "Italy", cluster: "n_italy", est: 1973, lat: 45.53, lon: 8.15, blurb: "Fine merino with quiet dimension — boardroom cloth, alive up close.", guidePath: ["cloth_origins", "suiting", "italian", "drago"], fabricKey: "drago_birdseye" },
    ...
    { key: "solbiati", short: "Solbiati", name: "Solbiati", place: "Busto Arsizio, Lombardy", region: "Italy", cluster: "n_italy", est: 1874, lat: 45.58, lon: 8.85, blurb: "Italy's great linen house — dry, honest cloth for real heat.", guidePath: ["cloth_origins", "suiting", "italian", "solbiati"], fabricKey: "linen_suiting" },
    ...
    { key: "e_thomas", short: "E. Thomas", name: "E. Thomas", place: "Brusimpiano, Lake Lugano", region: "Italy", cluster: "n_italy", est: 1922, lat: 45.94, lon: 8.87, blurb: "Refined jacketings and inventive wool-silk-linen blends, better known inside the trade than out.", guidePath: ["cloth_origins", "suiting", "italian", "e_thomas"] },
    ...
    { key: "monti", short: "Monti", name: "Monti", place: "Maserada sul Piave, Treviso", region: "Italy", est: 1911, lat: 45.72, lon: 12.35, blurb: "Crisp, finely finished Italian cottons — shirting that holds a collar all day.", guidePath: ["cloth_origins", "shirtings", "italian", "monti"] },
